  ...
  return (
    <Accordion type='single' collapsible>
        <AccordionItem value="item-1">
            <AccordionTrigger className='hover:no-underline'><h6 className='text-[13px] uppercase font-extrabold'>Description</h6></AccordionTrigger>
            <AccordionContent>
            <div>
        ...
        <AccordionItem value="item-2">
            <AccordionTrigger className='hover:no-underline'><h6 className='text-[13px]  uppercase font-extrabold text-left'>Reviews <span><Rating rating={product?.rating}/></span></h6></AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-3">
            <AccordionTrigger className='hover:no-underline'><h6 className='text-[13px] uppercase font-extrabold'>Shipping Information</h6></AccordionTrigger>
            <AccordionContent>
        ...
        <AccordionItem value="item-4">
            <AccordionTrigger className='hover:no-underline'><h6 className='text-[13px] uppercase font-extrabold'>Cancellation</h6></AccordionTrigger>
            <AccordionContent>
            <div>
                canncle
            </div>
