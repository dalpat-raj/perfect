        ...
        <div className='mt-6'>
            <form onSubmit={checkCoupon}>
                <div className='w-full flex justify-between items-center gap-4'>
                    ...
                    pl-2'
                    />
                    <button type='submit' className={clsx('bg-gray-200 text-[15px] py-3 px-4 rounded-lg text-gray-400', {'bg-green-400 text-white font-semibold' : couponApplyed === true})}>{couponApplyed ? "Success" : "Apply"}</button>
                </div>
            </form>
        </div>
        {/* price  */}
