    ...
    <div className="w-full h-full flex justify-center items-center my-6 px-2">
      <div className="w-3/12 max-lg:w-5/12 max-sm:w-full h-auto p-4 shadow-custom-shadow rounded-md">
        <section className="text-left">
          <h4 className="leading-none text-[18px] font-semibold text-gray-800 capitalize">Please Sign In</h4>
        ...
        <section className="my-4 text-center grid grid-cols-12 gap-2 items-center">
            ...
            <p className="col-span-6 text-[13px] font-semibold">OR SIGN-IN WITH</p>
            <div className="col-span-3 h-[1px] bg-gray-300"></div>
        </section>
        ...
        <p className="mt-4 text-[14px]">if not have a account <Link href={"/auth/sign-up"}><u>Sign Up</u></Link></p>
      </div>
